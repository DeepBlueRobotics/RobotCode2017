...
public class Drivetrain extends Subsystem implements DashboardInterface{
    ...
    public boolean isInArcadeDrive() {
    ...
    /**
     * 
     * @param a in Arcade: the drive value, in Tank: the left joystick value
     * @param b in Arcade: the turn value, in Tank: the right joystick value
     */
    public void drive() {
