 ...
 *
 */
public class Turret extends Subsystem implements DashboardInterface{
    ...
    private final SpeedController hoodMotor = RobotMap.turretHoodMotor;
    private final Encoder turretEncoder = RobotMap.turretTurretEncoder;
    private final Encoder hoodEncoder = RobotMap.turretHoodEncoder;
