 ...
 *
 */
public class SetTurretToShootingFromLift extends Command {
	double angleToBoiler;
	ShooterInterface shooter;
    public SetTurretToShootingFromLift(ShooterInterface shooter) {
    ...
    protected void initialize() {
    	angleToBoiler = Robot.getPref("AngleToBoilerInDegreesFromAirship", 0)*Robot.getPref("Alliance", 1);
